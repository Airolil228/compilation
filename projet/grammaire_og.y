        ...
        declaration_procedure: PROCEDURE { empile(pile_region, numregion);numregion++;} IDF liste_parametres corps    {
            ...
            sem_decl_proc($3, 0);depile(pile_region);
            printf("Declaration de procedure reconnue ! \n");
        }                  
        ;

        declaration_fonction: FONCTION { empile(pile_region, numregion);numregion++;} IDF liste_parametres RETOURNE type_simple corps  { sem_decl_fct($3, $6, 0); depile(pile_region); printf("Declaration de fonction reconnue ! \n");}
        ; 
